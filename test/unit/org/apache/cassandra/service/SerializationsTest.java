...
public class SerializationsTest extends AbstractSerializationsTester
{
    ...
    private void testValidationCompleteWrite() throws IOException
    {
        ...
        Validator v0 = new Validator(DESC, FBUtilities.getBroadcastAddressAndPort(), -1, PreviewKind.NONE, -1);
        ...
        Validator v1 = new Validator(DESC, FBUtilities.getBroadcastAddressAndPort(), -1, PreviewKind.NONE, -1);
