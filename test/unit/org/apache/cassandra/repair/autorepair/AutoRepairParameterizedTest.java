...
import static org.apache.cassandra.repair.autorepair.AutoRepairUtilsTest.repairType;
...
public class AutoRepairParameterizedTest extends CQLTester
{
    ...
    public void testMetrics()
    {
        ...
        AutoRepair.instance.repairStates.get(repairType).progress("", progressEvent);
    ...
    public void testTokenRangesNoSplit()
    {
        ...
        List<Pair<Token, Token>> ranges = new AutoRepairTokenRangeDefault().getRange(repairType, true, KEYSPACE, TABLE);
