...
public class AutoRepairTokenRangeDefault implements IAutoRepairTokenRange
{
    private static final Logger logger = LoggerFactory.getLogger(AutoRepairTokenRangeDefault.class);


    @Override
    public List<Pair<Token, Token>> getRange(boolean primaryRangeOnly, String keyspaceName)
    {
